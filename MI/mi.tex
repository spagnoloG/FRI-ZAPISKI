...
\begin{multicols}{2}
	...
	\begin{itemize}
		...
		\item \( A \) je \textbf{nedefinirana} \( \Leftrightarrow \) obstaja tako pozitivne kot negativne lastne vrednosti.
	\end{itemize}

	\subsubsection{Sylvestrov kriterij}
	Simetrična matrika \( A \) je pozitivno definitna natanko tedaj, ko so determinante vseh vodilnih glavnih podmatrik matrike \( A \) pozitivne.
