...
\begin{multicols}{2}
	...
	\textbf{(Razvoj po vrstici/stolpcu, predznaki kofaktorjev)}
	...
	\[
		\begin{aligned}
			...
			\nabla_{\vec{x}} L(\vec{x}^\star, \vec{\lambda}^\star, \vec{\mu}^\star) & = 0,                                     \\[2pt]
			\text{(\small{primarna dopustnost})}\quad
			g_i(\vec{x}^\star)                                                      & = 0 \quad \text{za } i = 1,2,\ldots,m,   \\
			h_j(\vec{x}^\star)                                                      & \le 0 \quad \text{za } j = 1,2,\ldots,r, \\[2pt]
			\text{(\small{dualna dopustnost})}\quad
			\mu_j^\star                                                             & \le 0 \quad \text{za } j = 1,2,\ldots,r, \\[2pt]
			\text{(\small{komplementarna utesnjenost})}\quad
