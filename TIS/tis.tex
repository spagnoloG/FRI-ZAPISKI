...
Kode oznacimo kot dvojcek $(n, k)$. $n$ predstavlja stevilo varnostnih bitov, k pa podatkovnih.
...
\tetbf{sistematicni kod} - prvih $k$ znakov koda je enakih sporocilu (podatkovnim bitom), ostalih $n-k$ znakov pa so
paritetni biti.
