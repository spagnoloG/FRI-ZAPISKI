...
\textbf{6.13} Vsaka lastnost, ki velja za vrstice determinante, velja tudi
za njene stolpce. Med drugim:
\begin{itemize}
...
\textbf{6.14 (kofaktorska formula)} Ce je A kvadratna matrika reda n,
...
\textbf{6.15} Inverzna matrika $A^{-1}$ matrike A je transponirana matrika kofaktorjev,
...
\textbf{6.16} Ploscina paralelograma, dolocenega z vektorjema $\vec{a}$ in $\vec{b} \in R^{2}$ je
enaka det([$\vec{a} \vec{b}$]), to je absolutni vrednosti determinante s stolpcema $\vec{a}$ in $\vec{b}$.

\textbf{6.17} Mesani produkt vektorjev $\vec{a}$ in $\vec{b}$ in $\vec{c}$ je enak determinanti matrike, ki 
