...
\begin{center}
    \begin{enumerate}
        \item \begin{math}
            \dfrac{1}{x} \rightarrow -\dfrac{1}{x^2}
        \end{math}
        \item \begin{math}
            x^n  \rightarrow nx^{n-1}
        \end{math}
        \item \begin{math}
            \sqrt{x} \rightarrow \dfrac{1}{2 \sqrt{x}}
        \end{math}
        \item \begin{math}
            \sqrt[n] x \rightarrow \dfrac{1}{n \sqrt[n]{x^{n-1}}}
        \end{math}
        \item \begin{math}
            \sin (a x) \rightarrow  a  \cos a x
        \end{math}
        \item  \begin{math}
            \cos (a x) \rightarrow - a \sin (a x)
        \end{math}
        \item \begin{math}
            \tan x \rightarrow \dfrac{1}{\cos^2 x} 
        \end{math}
        \item \begin{math}
        ...
        \end{math}
        \item \begin{math}
            log_a x \rightarrow \dfrac{1}{x \ln a}
        \end{math}
        \item \begin{math}
            \arcsin x \rightarrow \dfrac{1}{\sqrt {1 - x^2}}
        \end{math}
        \item \begin{math}
            \arccos x \rightarrow - \dfrac{1}{\sqrt{1 - x^2}}
        \end{math}
        \item \begin{math}
            \arctan x \rightarrow \dfrac{1}{1 + x^2}
        \end{math}
        \item \begin{math}
            \operatorname{arccot}x \rightarrow -\dfrac{1}{1 + x^2}
        \end{math}
    \end{enumerate}
\end{center}
