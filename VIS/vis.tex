...
\begin{center}
    {\huge \href{https://github.com/spagnoloG/VIS-FRI}{VIS/FRI} - Cheat Sheet \par}
\end{center}
...
pa velja $P(A | B) = 0$ in $P(A + B) = P(A) + P(B)$.
...
\begin{itemize}
    ...
    \item $P(X = k) = (1 - p)^{k - 1} p$ za $k = 1,2, \dots$ % in $P(X \leq k) = 1 - (1 - p)^{k}$% 
\end{itemize}
